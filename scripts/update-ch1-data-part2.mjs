...
deepseek.content[0].rows = [
  ...
  ["2025.03.24", "V3-0324", "V3 升级版，推理和编码显著提升", "core"],
  ["2025.05.28", "R1-0528", "AIME 2025 从 70.0→87.5，GPQA 从 71.5→81.0", "deep"],
  ["2025.08.21", "V3.1", "混合架构 thinking/non-thinking 切换，比 V3/R1 高 40%+", "core"],
  ["2025.09.17", "R1 登 Nature 封面", "中国大模型首次、全球首个经完整同行评审的主流 LLM 研究。NSA 获 ACL 2025 最佳论文", "deep"],
  ["2025.09.29", "V3.2-Exp", "DeepSeek Sparse Attention (DSA)，API 降价 50%+", "deep"],
  ["2025.12.01", "V3.2 / V3.2-Speciale", "685B，「GPT-5 级性能」，API $0.28/M tokens", "core"],
...
qwen.content[0].rows = [
  ...
  ["2025.07", "Qwen3-Coder", "480B-A35B(MoE)，256K 至 100 万上下文", "core"],
  ["2025.09", "Qwen3-Max / Qwen3-Next", "超稀疏 MoE + 多 token 预测新架构预览", "deep"],
];
...
baidu.content[0].rows = [
  ...
  ["2026.01", "ERNIE-5.0 正式发布", "原生全模态，超稀疏 MoE，>2.4T 参数，激活 <3%，昆仑芯三代训练", "core"],
];
...
xunfei.content[0].rows = [
  ["2025.04", "星火 X1 升级", "参数量比同类小一个数量级，效果对标 o1/R1", "core"],
...
stepfun.content[0].rows = [
  ["2025.01", "Step-Video-T2V", "30B 参数，最大开源视频生成模型（204 帧，中英双语）", "core"],
  ["2025.03", "Step-2", "万亿参数 MoE 语言模型，新一代自研 MFA 注意力架构", "core"],
  ["2025.03", "Step-Audio", "千亿参数端到端语音大模型，超低延迟实时对话", "deep"],
  ["2025.06", "Step1X-Edit", "通用图像编辑模型，11 类高频编辑任务，开源", "deep"],
];
...
otherCN.content[0].rows = [
  ...
  ["小红书", "2025.06", "dots.llm1：1420 亿参数 MoE，中文 C-Eval 92.2 超越 DeepSeek-V3", "deep"],
  ["零一万物", "2025.03", "宣布停止大模型预训练——DeepSeek 冲击波标志性事件", "core"],
];
